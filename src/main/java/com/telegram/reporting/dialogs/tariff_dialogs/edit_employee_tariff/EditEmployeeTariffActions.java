...
public class EditEmployeeTariffActions {
    ...
    public void requestChooseEditData(StateContext<EditEmployeeTariffState, EditEmployeeTariffEvent> context) {
    ...
    public void sendDataToEdit(StateContext<EditEmployeeTariffState, EditEmployeeTariffEvent> context) {
        Long chatId = CommonUtils.currentChatId(context);
    ...
    public void editTimeRecord(StateContext<EditEmployeeTariffState, EditEmployeeTariffEvent> context) {
    ...
    public void requestEditAdditionalData(StateContext<EditEmployeeTariffState, EditEmployeeTariffEvent> context) {
        Long chatId = CommonUtils.currentChatId(context);
        String editTimeRecordJson = CommonUtils.getContextVarAsString(context, ContextVarKey.TARGET_TIME_RECORD_JSON);
    ...
    public void sendCategoryButtons(StateContext<EditEmployeeTariffState, EditEmployeeTariffEvent> context) {
        Long chatId = CommonUtils.currentChatId(context);
        String timeRecordsJson = CommonUtils.getContextVarAsString(context, ContextVarKey.TIME_RECORDS_JSON);
    ...
    public void requestSaveTimeRecordChanges(StateContext<EditEmployeeTariffState, EditEmployeeTariffEvent> context) {
        Long chatId = CommonUtils.currentChatId(context);
        String editTimeRecordJson = CommonUtils.getContextVarAsString(context, ContextVarKey.TARGET_TIME_RECORD_JSON);
        TimeRecordTO timeRecordTO = JsonUtils.deserializeItem(editTimeRecordJson, TimeRecordTO.class);
    ...
    public void saveTimeRecordChanges(StateContext<EditEmployeeTariffState, EditEmployeeTariffEvent> context) {
        Long chatId = CommonUtils.currentChatId(context);
        String editTimeRecord = CommonUtils.getContextVarAsString(context, ContextVarKey.TARGET_TIME_RECORD_JSON);
    ...
    public void requestEditAdditionalTimeRecord(StateContext<EditEmployeeTariffState, EditEmployeeTariffEvent> context) {
        Long chatId = CommonUtils.currentChatId(context);
