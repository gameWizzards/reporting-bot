...
public class EditTariffActions {
    ...
    public void requestChooseEditData(StateContext<EditTariffState, EditTariffEvent> context) {
    ...
    public void sendDataToEdit(StateContext<EditTariffState, EditTariffEvent> context) {
        Long chatId = CommonUtils.currentChatId(context);
    ...
    public void editTimeRecord(StateContext<EditTariffState, EditTariffEvent> context) {
    ...
    public void requestEditAdditionalData(StateContext<EditTariffState, EditTariffEvent> context) {
        Long chatId = CommonUtils.currentChatId(context);
        String editTimeRecordJson = CommonUtils.getContextVarAsString(context, ContextVarKey.TARGET_TIME_RECORD_JSON);
    ...
    public void sendCategoryButtons(StateContext<EditTariffState, EditTariffEvent> context) {
        Long chatId = CommonUtils.currentChatId(context);
        String timeRecordsJson = CommonUtils.getContextVarAsString(context, ContextVarKey.TIME_RECORDS_JSON);
    ...
    public void requestSaveTimeRecordChanges(StateContext<EditTariffState, EditTariffEvent> context) {
        Long chatId = CommonUtils.currentChatId(context);
        String editTimeRecordJson = CommonUtils.getContextVarAsString(context, ContextVarKey.TARGET_TIME_RECORD_JSON);
        TimeRecordTO timeRecordTO = JsonUtils.deserializeItem(editTimeRecordJson, TimeRecordTO.class);
    ...
    public void saveTimeRecordChanges(StateContext<EditTariffState, EditTariffEvent> context) {
        Long chatId = CommonUtils.currentChatId(context);
        String editTimeRecord = CommonUtils.getContextVarAsString(context, ContextVarKey.TARGET_TIME_RECORD_JSON);
    ...
    public void requestEditAdditionalTimeRecord(StateContext<EditTariffState, EditTariffEvent> context) {
        Long chatId = CommonUtils.currentChatId(context);
