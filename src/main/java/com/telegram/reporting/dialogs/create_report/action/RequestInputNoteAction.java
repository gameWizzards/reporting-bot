...
@Slf4j
@Component
public class RequestInputNoteAction implements Action<CreateReportState, MessageEvent> {
    private final SendBotMessageService sendBotMessageService;

    public RequestInputNoteAction(SendBotMessageService sendBotMessageService) {
